                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="http://localhost:8000/"><img src="{{URL::to('frontend/images/home/logo.png')}}" alt="" /></a>
                        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">order successfully placed</h5>
      ...
      <div class="modal-body">
        ...
        <h3>We will contact as soon as possible</h3>
      </div>
