			...
			<tbody>
				...
				<tr>
					<td class="cart_product">
						<a href=""><img src="{{$v_contents->options->image}}" alt="" style="width: 120px; height: 150px;"></a>
					</td>
			...
			<div class="col-sm-6">
				<div class="total_area">
					...
					<?php if($customer_id != NULL) { ?>
						<a class="btn btn-default update" href="{{URL::to('/checkout')}}">Checkout</a>
					<?php }else{ ?>
						<a class="btn btn-default update" href="{{URL::to('/login-check')}}">Checkout</a>
					<?php } ?>
				</div>
			</div>
		</div>
