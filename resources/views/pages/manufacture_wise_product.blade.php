        ...
        <div class="product-image-wrapper">
            <div class="single-products">
             	<div class="productinfo text-center">
                    <img src="{{URL::to($v_manufacture_by_product->product_image)}}" alt="" style="height:230px;" />
            ...
            <?php if($v_manufacture_by_product->publication_status==0){ ?>                
                <img src="{{URL::to('frontend/images/home/new.png')}}" class="new" alt="" />
            <?php } ?>
            <?php if($v_manufacture_by_product->publication_status==1){ ?> 
