        ...
        <div class="product-image-wrapper">
            <div class="single-products">
             	<div class="productinfo text-center">
                    <img src="{{URL::to($v_published_product->product_image)}}" alt="" style="height:230px;" />
            ...
            <?php if($v_published_product->publication_status==0){ ?>                
                <img src="{{URL::to('frontend/images/home/new.png')}}" class="new" alt="" />
            <?php } ?>
            <?php if($v_published_product->publication_status==1){ ?> 
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="{{URL::to('/view_product/'.$v_published_product->product_id)}}"><i class="fa fa-plus-square"></i>Details</a></li>
                </ul>
            </div>
        </div>
    </div>
