        ...
        <div class="product-image-wrapper">
            <div class="single-products">
             	<div class="productinfo text-center">
                    <img src="{{URL::to($v_category_by_product->product_image)}}" alt="" style="height:230px;" />
            ...
            <?php if($v_category_by_product->publication_status==0){ ?>                
                <img src="{{URL::to('frontend/images/home/new.png')}}" class="new" alt="" />
            <?php } ?>
            <?php if($v_category_by_product->publication_status==1){ ?> 
                <img src="{{URL::to('frontend/images/home/sale.png')}}" class="new" alt="" />
            <?php } ?>
            </div>
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="#"><i class="fa fa-plus-square"></i>{{$v_category_by_product->category_name}}</a></li>
